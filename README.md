...
- 해결과정 <br>
알고 보니 도커에서 컨테이너 3개를 동시에 실행시켜서, ec2 프리티어가 용량을 감당하지 못해  멈추는 문제였습니다. 이 문제를 해결하기 위해 클라우드를 aws에서 ncp(네이버 클라우드 플랫폼)로 바꾸게 되었고 멈추는 문제는 해결되었습니다. 해결책이 너무 단순해서 약간의 허무함과 허탈함을 느끼기도 하였지만 그래도 도메인을 구입하고 HTTPS까지 적용하여 성공적으로 배포하였습니다.
