...
//        Instructor currentInstructor = authenticationFacade.getCurrentInstructor(); // 현재 로그인한 강사 정보 가져오기
        ...
        settlementDto.setInstructorId(/*currentInstructor.getId()*/ 1L); // SettlementDto에 강사 ID 설정

        SettlementFeeDto settlementFeeDto = service.settlementFeeFindByInstructorId(/*currentInstructor.getId()*/ 1L);
